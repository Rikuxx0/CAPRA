...
`app.py` is the Streamlit entrypoint for CAPRA Layer 1 Fact Extraction. Core parsing, schema, graph, and export logic lives under `capra/layer1/`. Repository-level assets currently include [README.md](/Users/rikuxx/CAPRA/README.md), `examples/`, and `demo.mp4`. Add new reusable logic under `capra/layer1/` rather than expanding `app.py`.
